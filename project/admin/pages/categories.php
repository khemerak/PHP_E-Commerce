                    ...
                    <?php else: ?>
                        <?php foreach ($categories as $category): ?>
                            <tr class="text-gray-700 dark:text-gray-400">
                                ...
                                <td class="px-4 py-3 text-sm"><?php echo htmlspecialchars($category['name']); ?></td>
                                ...
                                <td class="px-4 py-3 text-sm">
                                    <a href="?p=editCategory&id=<?php echo urlencode($category['category_id']); ?>" 
                                       class="text-blue-600 hover:underline">Edit</a>
                                    <a href="?p=deleteCategory&id=<?php echo urlencode($category['category_id']); ?>" 
            ...
            <span class="flex col-span-4 mt-2 sm:mt-auto sm:justify-end">
                <nav aria-label="Table navigation">
                    <ul class="inline-flex items-center">
                        <?php if ($page > 1): ?>
                            <li>
                                <a href="?p=categories&page=<?php echo $page - 1; ?>" 
                        ...
                        <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                            <li>
                                <a href="?p=categories&page=<?php echo $i; ?>" 
                                   class="px-3 py-1 rounded-md <?php echo $i === $page ? 'text-white bg-purple-600 border border-r-0 border-purple-600' : ''; ?> focus:outline-none focus:shadow-outline-purple">
                                    <?php echo $i; ?>
                                </a>
                            </li>
                        <?php endfor; ?>
